...
import com.beiing.greendaodemo.utils.ListUtils;
import com.beiing.greendaodemo.utils.StringUtils;
...
public abstract class AbstractDatabaseManager<M, K> implements IDatabase<M, K> {
	...
	private static final String DEFAULT_DATABASE_NAME = "notes-db";
